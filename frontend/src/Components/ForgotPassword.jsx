  ...
  async function sendDataToMail(values) {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_APP_URL}/api/user/ForgotPassword/`,
        values
      );
          ...
          >
            <div className="col-md-5">
              <div className="bg-login text-white h-100 d-flex align-items-center justify-content-center flex-column p-5 text-center">
                ...
                <p>Register Here</p>
                <Link to="/register">
                  <button className="btn btn-outline-light fw-bold rounded py-2 px-4">
                    Register
                  </button>
                </Link>
              </div>
            ...
            <div className="col-md-7 bg-light">
              <div className="text-center p-5">
                <i
                  className="fa-solid fa-lock text-main"
                  style={{ fontSize: "50px" }}
                ></i>
